...
export const metadata: Metadata = {
  title: 'Contact Us',
  description: 'Contact Mindful Wellness Center. We\'d love to hear from you about scheduling an appointment, our services, or support resources.',
  keywords: ['Contact Mindful Wellness Center', 'Support', 'Help', 'Get in Touch'],
}
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8 md:mb-12">
            ...
            <p className="text-base md:text-lg text-gray-600">
              Have questions about scheduling an appointment, our services, or support resources? We&#39;d love to hear from you.
            </p>
          </div>
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">info@mindfulwellnesscenter.com</p>
                    <p className="text-gray-600">support@mindfulwellnesscenter.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">(555) 123-4526</p>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      200 Wellness Way, Suite 100<br />
                      Medical Arts District<br />
                      Boulder, CO 80302
                    </p>
                  </div>
                </div>
